...
def init_retriever(vector_db: Chroma, data_chunked, top_k = APP_CONFIG.top_k):
    """
    Arg: 
...
def get_context(query: str, top_k = APP_CONFIG.top_k):
    """
    Arg:
    ...
    retriever = init_retriever(vector_db=db, data_chunked=data_chunked, top_k = top_k)
