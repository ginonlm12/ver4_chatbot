...
from Examples.example import get_example
import re
example_fewshot = get_example()
enum = Variable()
memory = ConversationBufferWindowMemory(k = example_fewshot["parameter"]["search_number_messages"],return_messages=True)
