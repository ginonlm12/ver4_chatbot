...
""") as demo:
    ...
    with gr.Row():
        ...
        #     label="Session ID",
        #     placeholder="Nhập Session ID của bạn...",
    ...
    with gr.Row(elem_classes="button-row"):
        ...
        submit_feedback = gr.Button("Lưu gợi ý")
    ...
    def handle_feedback(modify_text, user_id):
        ...
        return log_feedback(modify_text, human_feedback, ai_feedback, user_id, session_id)
    
    submit_feedback.click(handle_feedback, [modify_txt, user_id], [])
...
demo.launch(server_name="10.248.243.99", server_port=7790, share = True)